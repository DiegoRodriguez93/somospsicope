          ...
          <div className="row">
            <div className="col-12 contaier-brains">
              <img
                ...
                className="books"
                alt="books somospsicope"
              />
              <div className="text-on-books">
                <h1>{t("inicio-nuestas-capacitaciones")}</h1>
                <Link to="/capacitaciones" className="btn btn-purple">
                  Ver más
                </Link>
              </div>
            </div>
          ...
          <div className="row">
            <div className="col-12">
              <div className="container">
                ...
                >
                  <div
                    className="col-lg-4 sm-12 index2-box"
                    style={{ backgroundColor: "#8abd44" }}
                  >
                    <img
                      src="/images/iconos/capacitaciones.png"
                      alt="capacitaciones somospsicope"
                    />
                  ...
                  >
                    <img
                      src="/images/iconos/supervisiones.png"
                      alt="supervisiones somospsicope"
                    />
                    <h4>{t("inicio-card2")}</h4>
                    <p>{t("inicio-card2-sub")}</p>
                    <Link to="/supervisiones" className="btn btn-purple btn-sm">
                      Ver más
                    </Link>
                  </div>
                  <div
                  ...
                  >
                    <img
                      src="/images/iconos/materiales.png"
                      alt="materiales somospsicope"
                    />
                    <h4>{t("inicio-card3")}</h4>
                    <p>{t("inicio-card3-sub")}</p>
                    <Link to="/materiales" className="btn btn-purple btn-sm">
                      Ver más
                    </Link>
                  </div>
                </div>
          ...
          <div className="row index3">
            <div className="col-lg-6">
              <div className="row">
                <div className="col-lg-6">
                  <img
                    src="/images/index3-1.jpg"
                    className="ordenador"
                    alt="index3-1 somospsicope"
                  />
                </div>
                <div className="col-lg-6 sm-12 vertical-align">
                  ...
                  <button
                    onClick={() =>
                      redirect(
                        "https://www.instagram.com/somospsicope/channel/"
                      )
                    }
            ...
            <div className="col-lg-6">
              <div className="row">
                <div className="col-lg-6">
                  <img
                    src="/images/index3-2.jpg"
                    className="ordenador"
                    alt="index3-2 somospsicope"
                  />
                </div>
                <div className="col-lg-6 sm-12 vertical-align">

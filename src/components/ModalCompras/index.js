...
export default function ModalConsultorio({ setIsOpenModal, nombreProducto }) {
  ...
  const onSubmit = (data, e) => {
    ...
    const { fullName, email, phone, producto } = data;
    ...
    fetch("https://somospsicope.com/api/forms/mensajeCompra.php", {
      method: "POST",
      body: formData,
    })
  ...
  return (
    <div>
      ...
      >
        ...
        <h1 className="title title-purple">Compras</h1>
        <div className="row">
          <div className="col-lg-8 sm-12">
            <p>
              {t('modal-compras-description')}
            </p>
          </div>
